    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" id="form">
                <div class="card-header">Fiche de l'utilisateur</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="image_uri" class="col-md-4 col-form-label text-md-right">{{ __('Photo') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror mt-1" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
